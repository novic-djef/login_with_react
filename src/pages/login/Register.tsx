  ...
  <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-5xl p-3 items-center"> 
    <div className="md:w-1/2 px-8 md:px-12">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        <input className="p-2 rounded-xl border" type="name" name="text" placeholder=" votre nom" {...register('nom', {required: true})}/>
        ...
        <div className="relative">
          <input className="p-2 rounded-xl border w-full" type="password" name="password" placeholder="votre mot de passe" {...register('password', {required: true, minLength: 8})}/>
        ...
        <button className="bg-[#046db5] rounded-xl text-white py-2 hover:scale-105 duration-300"> valider </button>
      </form>
