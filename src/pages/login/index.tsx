  ...
  <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-5xl p-3 items-center"> 
    <div className="md:w-1/2 px-8 md:px-12">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        {errors.email && <p className="font-bold text-sm text-[#ff2e2e] size-2" >l'adresse mail est obligatoire</p>}
      ...
      <div className="mt-5 text-xs border-b border-[#046db5] py-4 text-[#046db5]">
